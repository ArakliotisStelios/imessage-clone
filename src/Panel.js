...
function Panel() {
    ...
    const [arrayMessages, setArrayMessages] = React.useState([obj, obj1, obj2, obj1, obj1, obj1, obj3, obj2, obj3]);
    ...
    const handleKeyDown = (event) => {
      ...
      const alignMessage = (message) => {
        if (message.user === "me"){
         ...
         return <p key={crypto.randomUUID()} className="from-them">{message.text}</p>;
      };
